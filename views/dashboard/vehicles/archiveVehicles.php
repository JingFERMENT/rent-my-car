<div class="card border-2 text-center">
    <div class="p-5">
        <h1>Liste des véhicules archivés</h1>
        ...
        <!-- LISTE DES VEHICULES ARCHIVES -->
        <div class="d-flex justify-content-end gap-5">
            <table class="table table-striped">
                <thead>
                    <tr>
                        <?php if ($sortByAsc) { ?>
                            <th scope="col"><a href="/controllers/dashboard/vehicles/archiveVehicles-ctrl.php?sort=false">Catégorie</a></th>
                        <?php ;} else { ?>
                            <th scope="col"><a href="/controllers/dashboard/vehicles/archiveVehicles-ctrl.php?sort=true">Catégorie</a></th>
                        <?php ;} ?>
                ...
                <tbody>
                    ...
                    foreach ($vehicles as $vehicle) { ?>
                        ...
                        <tr>
                            ...
                            <td>
                                <a class="text-dark" href="/controllers/dashboard/vehicles/reactivateVehicles-ctrl.php?id_vehicle=<?= $vehicle->id_vehicle ?>"><i class="fa-solid fa-arrows-rotate"></i></a>
                            </td>
                            <!-- Button trigger modal -->
                            <td><a type="button" data-id="<?= $vehicle->id_vehicle ?>" data-bs-toggle="modal" data-bs-target="#exampleModal" class="text-dark modalOpenVehicleBtn2"><i class="fa-solid fa-trash-can"></i></a></td>
                        </tr>
                    <?php } ?>
                </tbody>
            </table>
